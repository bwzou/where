...
public class ChatEmojiUtils {
    ...
    private static ChatEmojiUtils mChatEmojiUtils;
    ...
    private ChatEmojiUtils() {

    }

    public static ChatEmojiUtils getInstace() {
        if (mChatEmojiUtils == null) {
            mChatEmojiUtils = new ChatEmojiUtils();
        }
        return mChatEmojiUtils;
    }
