...
import com.creation.where.adapter.ChatEmojiAdapter;
import com.creation.where.adapter.ViewPagerAdapter;
import com.creation.where.po.ChatEmoji;
...
public class ChatEmojiRelativeLayout extends RelativeLayout implements
    ...
    /** 表情数据填充器 */
    private List<ChatEmojiAdapter> faceAdapters;
    ...
    public ChatEmojiRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public ChatEmojiRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        emojis = ChatEmojiUtils.getInstace().emojiLists;
        onCreate();
    }
    ...
    private void Init_viewPager() {
        ...
        // 中间添加表情页
        faceAdapters = new ArrayList<ChatEmojiAdapter>();
        for (int i = 0; i < emojis.size(); i++) {
            GridView view = new GridView(context);
            ChatEmojiAdapter adapter = new ChatEmojiAdapter(context, emojis.get(i));
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        if (!TextUtils.isEmpty(emoji.getCharacter())) {
            ...
            SpannableString spannableString = ChatEmojiUtils.getInstace()
